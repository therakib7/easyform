...
class Webhook
{
    ...
    {
        register_rest_route("rhef/v1", "/webhooks", [
            [
                "methods" => "GET",
                "callback" => [$this, "get"],
        ...
        register_rest_route("rhef/v1", "/webhooks/(?P<id>\d+)", [
            "methods" => "GET",
        ...
        register_rest_route("rhef/v1", "/webhooks/(?P<id>[0-9,]+)", [
            "methods" => "DELETE",
    ...
    {
        return current_user_can("rhef_webhook");
    }
